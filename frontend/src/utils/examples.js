export const EXAMPLES = {
  default:
    '2026年4月18日上午9点，星澜科技在上海张江办公室召开了“Atlas 知识中台”项目周会。项目负责人李明表示，该项目由星澜科技与复旦大学计算机学院联合推进，目标是在2026年7月底前完成第一阶段交付。会上，算法工程师周琪汇报说，团队已经完成了医疗文献数据清洗，共处理了12万篇中文论文，主要来自知网和万方数据库。产品经理陈雨提出，第一版系统将服务于华东医院和瑞金医院两个试点客户，核心功能包括实体识别、关系抽取、事件时间线生成和可视化问答。李明还提到，公司计划在5月10日前采购两台NVIDIA H100服务器，预算总额为280万元，采购负责人是供应链经理王涛。会议最后决定，由周琪在4月25日前提交关系抽取模型评估报告，由陈雨负责在4月28日与华东医院信息科主任赵文杰确认接口规范。',
  startup:
...
export const DEFAULT_GRAPH_DATA = {
  ...
  edges: [
    ...
    { source: '王涛', target: 'NVIDIA H100服务器', label: '采购' },
  ...
  timeline: [
    ...
    },
    {
      ...
      label: '采购 H100 服务器',
      time: '2026年5月10日前',
      detail: '公司计划采购两台 NVIDIA H100 服务器，预算总额为280万元，由王涛负责。',
      related_nodes: ['星澜科技', '王涛', 'NVIDIA H100服务器'],
    },
    {
      id: 't3',
      label: '提交模型评估报告',
